...
class lecturaController extends controlador{
   ...
   public function editarLectura()
   {
      ...
      if (isset($_POST['idLecturaSeleccionado']) && isset($_POST['cantidadMetrosCubicos'])) {
   ...
   {
      if (isset($_POST['cantidadMetrosCubicos']) && isset($_POST['idServicioLec'])) {
      ...
      */
      ...
      public function consultarLecturas()
      {
        ...
        if(isset($_POST['paginaActual']) && isset($_POST['filtroBusqueda'])) {
          ...
          $cadenaAtributos = "id_LecturaMedidor,cantidadMetrosCubicos_LecturaMedidor,fechaCreacion_LecturaMedidor,fechaModificacion_LecturaMedidor,tbServicioAgua_id_ServicioAgua";
