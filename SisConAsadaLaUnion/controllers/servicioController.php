	...
	private $clienteLogic;
	 ...
	 public function __construct(){
      ...
      public function editarServicio(){
        ...
        if(isset($_POST['idCliente']) && isset($_POST['tipoServicio']) && isset($_POST['cbEstado']) && isset($_POST['idnumNIS']) && isset($_POST['idServicio'])){
      ...
      public function registrarServicio(){
        ...
        if(isset($_POST['cbCliente']) && isset($_POST['tipoServicio']) && isset($_POST['cbEstado']) && isset($_POST['idnumNIS'])){
