  ...
  */
  function cargarListaRegistros(direccion,paginaActualProd,busqueda,idCuerpoTabla,colspan,valorIdServicio){

        $.ajax({
          url: direccion,
          type: "POST",
          data: { paginaActual : paginaActualProd , filtroBusqueda: busqueda, idServicio: valorIdServicio },
          dataType: "json",
          beforeSend: function(){
  ...
  */
  function listaPaginasConsultaRegistros(totalPaginas,paginasVisibles,paginaInicio,direccionCantidadPaginas,direccionConsultaRegistros,busqueda,idCuerpoTabla,colspan,valorIdServicio){
      ...
      $("#paginacion").twbsPagination({
        ...
        onPageClick: function (event, page) { 
          ...
          if (ejecucionOnLoad) {
            ...
            crearListaPaginasPaginacion(direccionCantidadPaginas,direccionConsultaRegistros,page,busqueda,idCuerpoTabla,colspan,valorIdServicio);
          }
          cargarListaRegistros(direccionConsultaRegistros,page,busqueda,idCuerpoTabla,colspan,valorIdServicio);
        }
      });
  ...
  */
  function crearListaPaginasPaginacion(direccionCantidadPaginas,direccionConsultaRegistros,paginaInicio,busqueda,idCuerpoTabla,colspan,valorIdServicio){

        $.ajax({
          url: direccionCantidadPaginas,
          type: "POST",
          data: { permisoConsultaTotalPaginas : "true", filtroBusqueda : busqueda, idServicio : valorIdServicio },
          dataType: "json",
          beforeSend: function(){
            ...
            if (respuesta["totalPaginas"] != "false") { 
              ...
              if (totalidadDePaginas <= 10) {
                ...
                listaPaginasConsultaRegistros(totalidadDePaginas,totalidadDePaginas,paginaInicio,
                                              ...
                                              busqueda,idCuerpoTabla,colspan,valorIdServicio);

              }else{

                listaPaginasConsultaRegistros(totalidadDePaginas,10,paginaInicio,direccionCantidadPaginas,
                                              direccionConsultaRegistros,busqueda,idCuerpoTabla,colspan,valorIdServicio);
  ...
  */
  function buscarRegistrosPorFiltro(direccionCantidadPaginas,direccionConsultaRegistros,idFiltroBusqueda,idCuerpoTabla,colspan,valorIdServicio){
    ...
    timeout = setTimeout(function() {
          ...
          crearListaPaginasPaginacion(direccionCantidadPaginas,direccionConsultaRegistros,1,busqueda,idCuerpoTabla,colspan,valorIdServicio);
  ...
  */
  function actualizarTabla(accionEjecutada,cantidadFilasTabla,idFiltroBusqueda,direccionCantidadPaginas,direccionConsultaRegistros,idCuerpoTabla,colspan,valorIdServicio) {
   ...
   crearListaPaginasPaginacion(direccionCantidadPaginas,direccionConsultaRegistros,paginaActualGlb,busqueda,idCuerpoTabla,colspan,valorIdServicio);
