   ...
   */
	...
	class telefonoLogic{
        ...
        */
        ...
        /*
        // Método encargado de obtener los telefonos de una persona por su id y formatearlos para que el controlador los envie a la vista
        */

        public function formatearTelefonosDePersonaPorId($idPersona){
        	
        	if ($this->generalValidation->validarCamposNumericosEnteros($idPersona)) {
		        ...
		        $tablaTelefonos = "<table id='tablaTelefonos' class='table table-striped table-condensed table-bordered table-hover'>
		          ...
		          if ($this->generalValidation->validarArray($telefonosPersona)) { //Formateando resultados para la vista (Si pasa el filtro)
		              ...
		              $tablaTelefonos = $tablaTelefonos."<tr><td colspan='2' style='text-align:center;'>No se encontraron teléfonos para esta persona</td></tr>";
		          }
        ...
        */
        ...
        public function formatearTelefonosDePersonaPorCedula($cedula){
